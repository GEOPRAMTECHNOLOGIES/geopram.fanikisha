...
class Config:
 ...
 DARAJA_ENV=os.environ.get("DARAJA_ENV","production"); DARAJA_BASE_URL=os.environ.get("DARAJA_BASE_URL","https://api.safaricom.co.ke"); DARAJA_CONSUMER_KEY=os.environ.get("DARAJA_CONSUMER_KEY",""); DARAJA_CONSUMER_SECRET=os.environ.get("DARAJA_CONSUMER_SECRET",""); DARAJA_PASSKEY=os.environ.get("DARAJA_PASSKEY",""); DARAJA_SHORTCODE=os.environ.get("DARAJA_SHORTCODE",""); DARAJA_TILL_NUMBER=os.environ.get("DARAJA_TILL_NUMBER",""); _daraja_root=os.environ.get("DARAJA_CALLBACK_URL","").strip().rstrip("/"); DARAJA_CALLBACK_URL=((_daraja_root + "/api/webhooks/daraja") if _daraja_root and not _daraja_root.endswith("/api/webhooks/daraja") else _daraja_root); DARAJA_TRANSACTION_TYPE=os.environ.get("DARAJA_TRANSACTION_TYPE","")
